<!-- Valentine modal -->
<div id="valentine_modal" style="display:none;">
	<div id="dialog" class="window">
		<table class="tblStdFullCentre" bgcolor="#fff" cellpadding="5">
			<tr>
				<td colspan="2">
					<a href="collection.php?cid=2">
						<img src="images/valentine_onsite.jpg" 
							title="The Valentine Collection" 
							width="624" height="312" border="0" />
					</a>
				</td>
			</tr>
			<tr>
				<td align="left">
					<a href="collection.php?cid=2"><b>Go to Valentine Collection &raquo;</b></a>
				</td>
				<td align="right">
...
<style>
/* Z-index of #mask must lower than #valentine_modal .window */
#mask {
  position:absolute;
  z-index:9000;
