					...
					<table class="tblStdFull">
						...
						<tr>
							<td valign="top">
								...
								<table class="tblStdFull" cellspacing="0">
									<tr>
										<td colspan="3">
...
<tr>
	<td>
		<br/><br/>
		<?php /* TODO - CHECK FOR JAVASCRIPT - IF NOT ENABLED THEN PUT AN EMAIL LINK IN INSTEAD */ ?>
		<a href="javascript:;" 
			onclick="simpleCart.add(
				'name=The Minsky (small) in red and black',
				'price=30.00',
				'quantity=1'
			);">
			Add to basket
