...
$sPageKeywords	= 'press, publicity, promotion, exhibition, stall, sell';
...
if ($_REQUEST['typeid'] != "")
	...
	$typeId = 3;	// default to stalls, shows and fairs

// Get the name of the selected type
$qType = "select Type from PublicityType where PublicityTypeID = $typeId limit 1";
					...
					<tr>
						<td valign="top">
							...
							<table class="tblStdFull" align="center" cellspacing="0" cellpadding="0">
								<tr><td colspan="2" class="tdHeading"><?php echo $typeName; ?></td></tr>
								...
								<tr>
									<td align="center">
										<table class="tblStdFull" cellspacing="0" cellpadding="0">
											<tr><td>&nbsp;</td></tr>
											<?php
											// Get current publicity details for the given type
											$qPublicity	= "select * from Publicity where PublicityTypeID = $typeId and Display = 1 order by StartDate desc";
